...
#define LOG_TAG "android.hardware.usb.gadget@1.0-service.intel"
...
#define GADGET_NAME "dwc3.0.auto"
...
static V1_0::Status validateAndSetVidPid(uint64_t functions) {
  ...
  switch (functions) {
    case static_cast<uint64_t>(GadgetFunction::MTP):
        ret = setVidPid("0x8087", "0x0a5e");
      break;
    case GadgetFunction::ADB | GadgetFunction::MTP:
        ret = setVidPid("0x8087", "0x0a5f");
      break;
    case static_cast<uint64_t>(GadgetFunction::PTP):
        ret = setVidPid("0x8087", "0x0a60");
      break;
    case GadgetFunction::ADB | GadgetFunction::PTP:
        ret = setVidPid("0x8087", "0x0a61");
      break;
    case static_cast<uint64_t>(GadgetFunction::ADB):
        ret = setVidPid("0x8087", "0x09ef");
      break;
...
V1_0::Status UsbGadget::setupFunctions(
  ...
  if (strstr(vendorFunctions.c_str() , "mtp"))
      functions |= GadgetFunction::MTP;
  if (strstr(vendorFunctions.c_str(), "ptp"))
      functions |= GadgetFunction::PTP;

  if (functions & GadgetFunction::MTP) {
    ffsEnabled = true;
  ...
  } else if (functions & GadgetFunction::PTP) {
    ffsEnabled = true;
